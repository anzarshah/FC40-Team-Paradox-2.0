  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:
            Text("Rejection of Application", style: TextStyle(color: greyish)),
        elevation: 0,
      ),
      body: Container(
          child: _isLoading
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "We are really sorry but unfortunately your application was rejected as it didn't fulfill our criterias.",
