...
class ApprovalInProcess extends StatefulWidget {
  const ApprovalInProcess({Key? key}) : super(key: key);

  @override
  _ApprovalInProcessState createState() => _ApprovalInProcessState();
}

class _ApprovalInProcessState extends State<ApprovalInProcess> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Approval in process", style: TextStyle(color: greyish)),
        elevation: 0,
      ),
      body: Container(
          child: _isLoading
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "We are still processing your application. We'll get back to you once we are done with it.",
